addLayer("q", {
	...
	sf1 = new Decimal(0.01)
	    ...
	    if (exp2.gte("1e25")) exp2 = exp2.div(1e25).pow(sf1).mul(1e25)
	    if (hasUpgrade('P', 11)) exp2 = exp2.log10().mul(6).pow(1.673).pow_base(10)
	    if (exp2.gte("1e50")) exp2 = exp2.div(1e50).pow(0.06).mul(1e50)
	    if (exp2.gte("1e100")) exp2 = exp2.div(1e100).pow(0.02).mul(1e100)
